...
import { SkillUpgradation } from './skill-upgradation';

@Injectable({
  providedIn: 'root'
})
export class SkillUpgradationService {

  private baseUrl = 'http://localhost:8080/AbstractProject_01';
  private apiUrl = this.baseUrl + '/skill-upgradation/';
