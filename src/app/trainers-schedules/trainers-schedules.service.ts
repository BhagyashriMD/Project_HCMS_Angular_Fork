...
import { TrainersSchedules } from './trainers-schedules';

@Injectable({
  providedIn: 'root'
})
export class TrainersSchedulesService {

  private baseUrl = 'http://localhost:8080/AbstractProject_01';
  private apiUrl = this.baseUrl + '/trainers-schedules/';
